...
export default function LoginPage() {
  ...
  return (
    <main className="auth-page">
      <section className="auth-brand"><img className="auth-logo-image" src="/brand/kea-logo.jpg" alt="KEA Corporate Hospitality Services" /><p>Kea</p><h1>Talent management<br />for every field team.</h1><span>One secure workspace for people, outlets, routes, and growth.</span></section>
