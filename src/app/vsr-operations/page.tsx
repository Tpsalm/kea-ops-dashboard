...
export default function VsrOperationsPage() {
  ...
  useEffect(() => {
    try {
      ...
      if (isUrgentPending === "true") {
        ...
        const sessionSeen = sessionStorage.getItem("kea_seen_alert_vsr");
        if (!sessionSeen) {
          setUrgentModalOpen(true);
          sessionStorage.setItem("kea_seen_alert_vsr", "true");
        }
      }
    } catch {}
  }, []);
  ...
  return (
    <div className={isDark ? "vsr-reference dark" : "vsr-reference"}>
        ...
        <header className="reference-topbar">
          ...
          <div className="reference-actions">
            <button
              ...
              title="View Urgent VSR Directives"
            >
              <span style={{
      ...
      <UrgentLoginModal
        role="vsr"
        userName={userName || "Babatunde Adeleke"}
